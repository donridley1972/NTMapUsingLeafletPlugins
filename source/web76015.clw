   ...
   MEMBER('web76.clw')                                     ! This is a MEMBER module
                     ...
                     MAP
                       INCLUDE('WEB76015.INC'),ONCE        !Local module procedure declarations
                     END
...
FilesErrorOnOpen  StringTheory
  CODE
  GlobalErrors.SetProcedureName('BrowseAccident')
  ...
  If p_web.site.ContentBody <> '' and lower(p_web.GetValue('_cb_')) = lower('BrowseAccident') then loc:ContentBody=1.
  if loc:RandomBrowseId = '' then loc:RandomBrowseId = p_web.Crc32(clip(loc:parent) & ' BrowseAccident' & p_web.GetValue('_parentRow_')).
  ...
  If loc:parent <> '' and loc:ParentRow <> ''
    loc:divname = lower(clip(loc:parent) & net:PARENTSEPARATOR & 'BrowseAccident' & net:PARENTSEPARATOR & lower(loc:parentRow))
    p_web.GetBrowseValue(p_web.GetValue('_parentRow_')) ! need to reget, so it's not lowered
  elsif loc:parent <> ''
    loc:divname = lower(clip(loc:parent) & net:PARENTSEPARATOR & 'BrowseAccident')
  else
    loc:divname = lower('BrowseAccident')
  end
...
loc:percentage  long
  code
  loc:percentage = p_web.GSV('Export_BrowseAccident_PercentageComplete')
...
Percentage      Long
  code
  ExcelExport.SetWorkSheet('Accident')
  ExcelExport.WithWorkSheet('Accident')
  do OpenFilesB
  If p_web.sqlsync then p_web.SqlWait(p_web.SqlName).
  Open(ThisView)
  ThisView{prop:order} = p_web.GetSessionValue('BrowseAccident_CurrentOrder_' & loc:RandomBrowseId)
  ThisView{prop:filter} = p_web.GetSessionValue('BrowseAccident_CurrentFilter_' & loc:RandomBrowseId)
  ExpectedRecords = records(Accident)
  ...
  ExcelExport.SetCell(rowNumber,1,p_web.translate('Accident'),'d151')
  ...
  ColumnNumber = 0
  ColumnNumber += 1
  ExcelExport.SetCell(rowNumber,ColumnNumber,'Date','s153')
  if Len(Clip('Date')) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip('Date')).
  If upper(sub(p_web.site.datepicture,2,1)) = 'D'
    DateColumn[ColumnNumber] = ExcelExport.AddDatePicture(p_web.site.datepicture)
  ElsIf upper(sub(p_web.site.datepicture,2,1)) = 'T'
    TimeColumn[ColumnNumber] = ExcelExport.AddTimePicture(p_web.site.datepicture)
  End
  ColumnNumber += 1
  ExcelExport.SetCell(rowNumber,ColumnNumber,'Time','s153')
  if Len(Clip('Time')) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip('Time')).
  If upper(sub('@t1',2,1)) = 'D'
    DateColumn[ColumnNumber] = ExcelExport.AddDatePicture('@t1')
  ElsIf upper(sub('@t1',2,1)) = 'T'
    TimeColumn[ColumnNumber] = ExcelExport.AddTimePicture('@t1')
  End
  ColumnNumber += 1
  ExcelExport.SetCell(rowNumber,ColumnNumber,'','s153')
  ...
  End
  ColumnNumber += 1
  ExcelExport.SetCell(rowNumber,ColumnNumber,'Latitude','s153')
  if Len(Clip('Latitude')) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip('Latitude')).
  If upper(sub('@n-20.12',2,1)) = 'D'
    DateColumn[ColumnNumber] = ExcelExport.AddDatePicture('@n-20.12')
  ElsIf upper(sub('@n-20.12',2,1)) = 'T'
    TimeColumn[ColumnNumber] = ExcelExport.AddTimePicture('@n-20.12')
  End
  ColumnNumber += 1
  ExcelExport.SetCell(rowNumber,ColumnNumber,'Longitude','s153')
  if Len(Clip('Longitude')) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip('Longitude')).
  If upper(sub('@n-20.12',2,1)) = 'D'
    DateColumn[ColumnNumber] = ExcelExport.AddDatePicture('@n-20.12')
  ElsIf upper(sub('@n-20.12',2,1)) = 'T'
    TimeColumn[ColumnNumber] = ExcelExport.AddTimePicture('@n-20.12')
  ...
  LOOP
    ...
    p_web.SetSessionValue('Export_BrowseAccident_PercentageComplete',percentage)
    ExcelExport.SetRow(rowNumber)
    ColumnNumber += 1
    If DateColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,p_web.FormatValue(Acc:Date,'@D010-B'),'d' &  DateColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    ElsIf TimeColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,'1899-12-31T' & p_web.FormatValue(Acc:Date,'@T04B'),'t' &  TimeColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    Else
      ExcelExport.SetCell(rowNumber,ColumnNumber,Acc:Date)
      If Len(Clip(Acc:Date)) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip(Acc:Date)).
    End
    ColumnNumber += 1
    If DateColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,p_web.FormatValue(Acc:Time,'@D010-B'),'d' &  DateColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    ElsIf TimeColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,'1899-12-31T' & p_web.FormatValue(Acc:Time,'@T04B'),'t' &  TimeColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    Else
      ExcelExport.SetCell(rowNumber,ColumnNumber,Acc:Time)
      If Len(Clip(Acc:Time)) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip(Acc:Time)).
    End
    ColumnNumber += 1
    If DateColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,p_web.FormatValue(choose(Acc:Type,'Car','Bike','Bus','Truck','Pedestrian'),'@D010-B'),'d' &  DateColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    ElsIf TimeColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,'1899-12-31T' & p_web.FormatValue(choose(Acc:Type,'Car','Bike','Bus','Truck','Pedestrian'),'@T04B'),'t' &  TimeColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    Else
      ExcelExport.SetCell(rowNumber,ColumnNumber,choose(Acc:Type,'Car','Bike','Bus','Truck','Pedestrian'))
      If Len(Clip(choose(Acc:Type,'Car','Bike','Bus','Truck','Pedestrian'))) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip(choose(Acc:Type,'Car','Bike','Bus','Truck','Pedestrian'))).
    End
    ColumnNumber += 1
    If DateColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,p_web.FormatValue(Acc:Description,'@D010-B'),'d' &  DateColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    ElsIf TimeColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,'1899-12-31T' & p_web.FormatValue(Acc:Description,'@T04B'),'t' &  TimeColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    Else
      ExcelExport.SetCell(rowNumber,ColumnNumber,Acc:Description)
      If Len(Clip(Acc:Description)) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip(Acc:Description)).
    End
    ColumnNumber += 1
    If DateColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,p_web.FormatValue(Acc:Latitude,'@D010-B'),'d' &  DateColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    ElsIf TimeColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,'1899-12-31T' & p_web.FormatValue(Acc:Latitude,'@T04B'),'t' &  TimeColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    Else
      ExcelExport.SetCell(rowNumber,ColumnNumber,Acc:Latitude)
      If Len(Clip(Acc:Latitude)) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip(Acc:Latitude)).
    End
    ColumnNumber += 1
    If DateColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,p_web.FormatValue(Acc:Longitude,'@D010-B'),'d' &  DateColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    ElsIf TimeColumn[ColumnNumber]
      ExcelExport.SetCell(rowNumber,ColumnNumber,'1899-12-31T' & p_web.FormatValue(Acc:Longitude,'@T04B'),'t' &  TimeColumn[ColumnNumber],,'DateTime')
      If 12 > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = 12.
    Else
      ExcelExport.SetCell(rowNumber,ColumnNumber,Acc:Longitude)
      If Len(Clip(Acc:Longitude)) > ColumnWidth[ColumnNumber] then ColumnWidth[ColumnNumber] = Len(Clip(Acc:Longitude)).
    End
    rowNumber += 1
  End
  ...
  End
  ExcelExport.Save()
  p_web.SetSessionValue('Export_BrowseAccident_PercentageComplete',100)
  p_web.HeaderDetails.ContentDisposition = 'attachment; filename="' & clip('Accident') & '.xml"'
...
parent_       string(100)
  code
  If loc:parent
    p_web.AlertParent('BrowseAccident')
  End
...
loc:PopupName    String(252)
  code
    ...
    if loc:CallPopups = 1 or loc:CallPopups = 6 ! browse not embedded on form so include popup divs and scripts for this browse
      if loc:CallPopups = 1 then loc:PopupName = 'BrowseAccident' else loc:PopupName = clip(loc:parent) & net:PARENTSEPARATOR & 'BrowseAccident' .
      if p_web.GetPreCall('popup_' & clip(loc:PopupName)) = 0
        ...
        p_web.DivHeader(clip(loc:PopupName),p_web.combine(p_web.site.style.browsediv,),,'BrowseAccident',,1)
        ...
        End
        p_web.jQuery('#' & lower('popup_BrowseAccident_div'),'dialog',loc:options,'.removeClass("nt-hidden")') !& |
...
ClearBrowse  Routine
  p_web.ClearBrowse('BrowseAccident_' & loc:randomBrowseId)
...
CallBrowse  Routine
  ...
  If loc:FrontLoading = 0
    ...
    do Children
    If p_web.site.ContentBody <> '' and lower(p_web.GetValue('_cb_')) = lower('BrowseAccident')
      p_web.Divfooter()
    End
    do ClosingScripts
    do SendPacket
...
LookupAbility  Routine
  If p_web.IfExistsValue('Lookup_Btn')
    ...
    p_web.PrimeForLookup(Accident,Acc:GuidKey,loc:vorder)
    If False
    ElsIf (loc:vorder = 'ACC:DATE') then p_web.SetValue('BrowseAccident_sort','8')
    ElsIf (loc:vorder = 'ACC:TIME') then p_web.SetValue('BrowseAccident_sort','9')
    ElsIf (loc:vorder = 'ACC:TYPE') then p_web.SetValue('BrowseAccident_sort','10')
    ElsIf (loc:vorder = 'ACC:DESCRIPTION') then p_web.SetValue('BrowseAccident_sort','1')
    ElsIf (loc:vorder = 'ACC:LATITUDE') then p_web.SetValue('BrowseAccident_sort','2')
    ElsIf (loc:vorder = 'ACC:LONGITUDE') then p_web.SetValue('BrowseAccident_sort','3')
    End
  End
  If p_web.IfExistsValue('LookupField') and p_web.GetValue('BrowseAccident:parentIs') <> 'Browse'
    loc:selecting = true
    p_web.StoreValue('BrowseAccident:LookupField','LookupField')
  elsif p_web.Ajax > 0 and p_web.IfExistsSessionValue('BrowseAccident:LookupField') > 0
    loc:selecting = true
  else
    p_web.DeleteSessionValue('BrowseAccident:LookupField')
    loc:selecting = false
  End
...
loc:options             StringTheory ! options for jQuery calls
  ...
  If (loc:popup = 0 or p_web.site.FrontLoaded = 1)
    ...
    If p_web.GetPreCall('UpdateAccident') = 0 then UpdateAccident(p_web,Net:Web:Popup).  !Form Procedure
    p_web.SetValue('_CallPopups',0)
    p_web.PopEvent()
  End

SetFormAction  Routine
  loc:formaction = 'UpdateAccident'
...
Heading  Routine
  If band(loc:stage,net:web:GenerateHeadings + net:web:UpdateHeadings)
    ...
    Else
      loc:Heading = p_web.Translate('Accident',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    End
    do SendPacket
...
SetSortHeader  Routine
  ...
  Of upper('Acc:Date')
    loc:SortHeader = p_web.Translate('Date',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    p_web.SetSessionValue('BrowseAccident_LocatorPic_' & clip(loc:RandomBrowseId),p_web.site.datepicture)
    loc:LocatorType = Net:Date       ! default locator type set at column level, date column detected
  Of upper('Acc:Time')
    loc:SortHeader = p_web.Translate('Time',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    p_web.SetSessionValue('BrowseAccident_LocatorPic_' & clip(loc:RandomBrowseId),'@t1')
    loc:LocatorType = Net:Position !Net:Time      ! default locator type set at column level, time column detected
  Of upper('Acc:Type')
    loc:SortHeader = p_web.Translate('',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    p_web.SetSessionValue('BrowseAccident_LocatorPic_' & clip(loc:RandomBrowseId),'@s20')
    loc:LocatorType = Net:Search     ! default locator type for this browse
  Of upper('Acc:Description')
    loc:SortHeader = p_web.Translate('Description',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    p_web.SetSessionValue('BrowseAccident_LocatorPic_' & clip(loc:RandomBrowseId),'@s255')
    loc:LocatorType = Net:Search     ! default locator type for this browse
  Of upper('Acc:Latitude')
    loc:SortHeader = p_web.Translate('Latitude',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    p_web.SetSessionValue('BrowseAccident_LocatorPic_' & clip(loc:RandomBrowseId),'@n-20.12')
    loc:LocatorType = Net:Position ! default locator is Search but this is a numeric column
  Of upper('Acc:Longitude')
    loc:SortHeader = p_web.Translate('Longitude',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))
    p_web.SetSessionValue('BrowseAccident_LocatorPic_' & clip(loc:RandomBrowseId),'@n-20.12')
    loc:LocatorType = Net:Position ! default locator is Search but this is a numeric column
  End

SetVorder  Routine
  loc:vordernumber    = p_web.RestoreValue('BrowseAccident_sort_' & loc:RandomBrowseId,net:DontEvaluate)
  ThisView &= View:Accident
  If loc:vordernumber = 0
    loc:vordernumber = 1
  End
  p_web.SetSessionValue('BrowseAccident_sort_' & loc:RandomBrowseId ,loc:vordernumber)
  Loc:SortDirection = choose(loc:vordernumber < 0,-1,1)
  case abs(loc:vordernumber)
  of 8
    loc:vorder = Choose(Loc:SortDirection=1,'Acc:Date','-Acc:Date')
    Loc:LocateOnFields = 'Acc:Date'
    Loc:LocateField = 'Acc:Date'
    Loc:LocatorCase = 0
  of 9
    loc:vorder = Choose(Loc:SortDirection=1,'Acc:Time','-Acc:Time')
    Loc:LocateOnFields = 'Acc:Time'
    Loc:LocateField = 'Acc:Time'
    Loc:LocatorCase = 0
  of 10
    loc:vorder = Choose(Loc:SortDirection=1,'Acc:Type','-Acc:Type')
    Loc:LocateOnFields = 'Acc:Type'
    Loc:LocateField = 'Acc:Type'
    Loc:LocatorCase = 0
  of 1
    loc:vorder = Choose(Loc:SortDirection=1,'UPPER(Acc:Description)','-UPPER(Acc:Description)')
    Loc:LocateOnFields = 'Acc:Description'
    Loc:LocateField = 'Acc:Description'
    Loc:LocatorCase = 0
  of 2
    loc:vorder = Choose(Loc:SortDirection=1,'Acc:Latitude','-Acc:Latitude')
    Loc:LocateOnFields = 'Acc:Latitude'
    Loc:LocateField = 'Acc:Latitude'
    Loc:LocatorCase = 0
  of 3
    loc:vorder = Choose(Loc:SortDirection=1,'Acc:Longitude','-Acc:Longitude')
    Loc:LocateOnFields = 'Acc:Longitude'
    Loc:LocateField = 'Acc:Longitude'
    Loc:LocatorCase = 0
  end
  if loc:vorder = ''
    loc:vorder = '+UPPER(Acc:Guid)'
  end
...
loc:options             StringTheory ! options for jQuery calls
  ...
  If loc:selecting = true
    ...
    loc:selectaction = p_web.FormSettings.ParentPage !p_web.GetSessionValue('BrowseAccident:LookupFrom')
    p_web.GetSettings(p_web.GetSessionValue('Push1'))
    loc:CancelAction = p_web.FormSettings.ParentPage !p_web.GetSessionValue('BrowseAccident:LookupFrom')
  End !Else
...
BrowseTable  routine
  ...
  if loc:ParentSilent = false
    ...
    If p_web.RequestJson = 0
      packet.append(p_web.BrowseTableRowStart('',' nt-browse-row-header browseaccident-row-header','browse-header-row','',loc:LayoutMethod))
    Else
    ...
    If p_web.RequestJson
      packet.append('"cells":[')
    End
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'8','BrowseAccident',p_web.Translate('Date',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),'Click here to sort by Date',,,p_web.Combine(),1, loc:columns+1 ,,,0,loc:Sorting,'Date','nt-left',loc:LayoutMethod,' title="'&p_web._jsok('Click here to sort by Date')&'"',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'9','BrowseAccident',p_web.Translate('Time',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),'Click here to sort by Time',,,p_web.Combine(),1, loc:columns+1 ,,,0,loc:Sorting,'String','nt-left',loc:LayoutMethod,' title="'&p_web._jsok('Click here to sort by Time')&'"',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'10','BrowseAccident',p_web.Translate('',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),'Click here to sort by ',,,p_web.Combine(),1, loc:columns+1 ,,,0,loc:Sorting,'String','nt-left',loc:LayoutMethod,' title="'&p_web._jsok('Click here to sort by ')&'"',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'1','BrowseAccident',p_web.Translate('Description',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),'Click here to sort by Description',,,p_web.Combine(),1, loc:columns+1 ,,,0,loc:Sorting,'String','nt-left',loc:LayoutMethod,' title="'&p_web._jsok('Click here to sort by Description')&'"',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'2','BrowseAccident',p_web.Translate('Latitude',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),'Click here to sort by Latitude',,,p_web.Combine(),1, loc:columns+1 ,,,0,loc:Sorting,'String','nt-left',loc:LayoutMethod,' title="'&p_web._jsok('Click here to sort by Latitude')&'"',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'3','BrowseAccident',p_web.Translate('Longitude',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),'Click here to sort by Longitude',,,p_web.Combine(),1, loc:columns+1 ,,,0,loc:Sorting,'String','nt-left',loc:LayoutMethod,' title="'&p_web._jsok('Click here to sort by Longitude')&'"',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
        If loc:Selecting = 0
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'4','BrowseAccident',p_web.Translate(,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,p_web.Combine(),1, loc:columns+1 ,,,1,loc:Sorting,'Button','nt-left',loc:LayoutMethod,'',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
        End ! Selecting
        If loc:Selecting = 0
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'5','BrowseAccident',p_web.Translate(,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,p_web.Combine(),1, loc:columns+1 ,,,1,loc:Sorting,'Button','nt-left',loc:LayoutMethod,'',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
        End ! Selecting
        If loc:Selecting = 0
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'6','BrowseAccident',p_web.Translate(,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,p_web.Combine(),1, loc:columns+1 ,,,1,loc:Sorting,'Button','nt-left',loc:LayoutMethod,'',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
        End ! Selecting
        If loc:Selecting = 1
            If p_web.RequestJSON then packet.append(',').
            packet.append(p_web.CreateSortHeader(loc:vordernumber,'7','BrowseAccident',p_web.Translate(,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,p_web.Combine(),1, loc:columns+1 ,,,1,loc:Sorting,'Button','nt-left',loc:LayoutMethod,'',loc:CellStarted,0 + 1))
            loc:CellStarted = false
            do AddPacket
            loc:columns += 1
        End ! Selecting
    ...
    if loc:found = 0
      If p_web.RequestJson = 0
        ...
        packet.append(p_web.Translate('no Accident'))
        packet.append(p_web.BrowseTableCellEnd('',loc:LayoutMethod))
        packet.append(p_web.BrowseTableRowEnd('',loc:LayoutMethod))
      Else
        packet.append('"rows":[ {{"row":{{"cells":[{{"cell":{{"class":"'&p_web.combine(p_web.site.style.BrowseEmpty,)&'",content:"'&p_web.Translate('no Accident')&'"}}]}}]')
      End
      do AddPacket
    ...
    p_web.SetSessionValue('BrowseAccident_prop:Order_' & loc:RandomBrowseId,ThisView{prop:order})
    p_web.SetSessionValue('BrowseAccident_prop:Filter_' & loc:RandomBrowseId,ThisView{prop:filter})
    Close(ThisView)
    If p_web.sqlsync then p_web.SqlRelease(p_web.SqlName).
    ...
    do SendPacket
  End
  packet.append(p_web.DivFooter(Net:NoSend,'BrowseAccident_table_div',p_web.RequestJson)) ! Table Div
  do SendPacket
  If loc:FrontLoading = 0
    do SendPacket
  End
  ...
  if(loc:FileLoading=Net:PageLoad)
    p_web.SetSessionValue('BrowseAccident_FirstValue_' & loc:RandomBrowseId,loc:firstvalue)
    p_web.SetSessionValue('BrowseAccident_LastValue_' & loc:RandomBrowseId,loc:lastvalue)
  End
  do CloseFilesB
...
loc:viewoptions  Long
  ...
  End
  If Instring('acc:guid',lower(loc:vorder),1,1) = 0 !and Accident{prop:SQLDriver} = 1
    loc:vorder = Choose(loc:vorder='','UPPER(Acc:Guid)',clip(loc:vorder) & ',' & 'UPPER(Acc:Guid)')
  End
  Loc:Selected = Choose(p_web.IfExistsValue('Acc:Guid'),p_web.GetValue('Acc:Guid'),p_web.GetSessionValue('Acc:Guid'))
  ...
  if loc:filterwas <> p_web.GetSessionValue('BrowseAccident_Filter_' & loc:RandomBrowseId)
    p_web.SetSessionValue('BrowseAccident_FirstValue_' & loc:RandomBrowseId,'')
    p_web.SetSessionValue('BrowseAccident_Filter_' & loc:RandomBrowseId,loc:filterwas)
  end
  do FindAnchor
  p_web.SetSessionValue('LocatorField:' & clip(loc:divname),lower(left(Loc:LocateField)))
  p_web.SetView(ThisView,Accident,Acc:GuidKey,loc:PageRows,'BrowseAccident',left(Loc:LocateOnFields),left(Loc:LocateField),loc:FileLoading,loc:LocatorType,clip(loc:LocatorValue),Loc:SortDirection,loc:ViewOptions,Loc:FillBack,Loc:Direction,loc:NextDisabled,loc:PreviousDisabled,Loc:LocatorCase,loc:RandomBrowseId) ! loc:pagerows is not used in here.
  p_web.SetSessionValue('BrowseAccident_CurrentOrder_' & loc:RandomBrowseId,ThisView{prop:order})
  p_web.SetSessionValue('BrowseAccident_CurrentFilter_' & loc:RandomBrowseId,ThisView{prop:filter})
  If loc:LocatorBlank = 0 or Loc:LocatorValue <> '' or Loc:LocatorType = Net:Date or loc:LocatorType = Net:Position or loc:LocatorType = Net:NoLocator
    ...
    Loop
      ...
      If(loc:FileLoading=Net:PageLoad)
        ...
        End
      End
      loc:viewstate = p_web.escape(p_web.Base64Encode(clip(Acc:Guid)))
      do BrowseRow
      loc:recordsCount += 1
    end ! loop
    loc:InView = 0
    ...
    If p_web.RequestJson = 0
      packet.append(p_web.BrowseTableRowStart('',' nt-browse-locator-row browseaccident-locator-row','browse-locator-row','',loc:LayoutMethod))
      packet.append(p_web.BrowseTableCellStart('',' nt-browse-locator-cell browseaccident-locator-cell',1,1,1,1,'browse-locator-cell','',loc:LayoutMethod))
...
GenerateUpdateButtonsAbove  Routine
  If (loc:UpdateButtonPosition=Net:Above or loc:UpdateButtonPosition=Net:Both) and band(loc:stage,net:web:GenerateUpdates)
    ...
    If (loc:selecting = 0 or loc:popup)
      If p_web.CanCall('UpdateAccident',0,,) = net:ok
        If loc:viewonly = 0
          packet.append(p_web.CreateStdBrowseButton(Net:Web:InsertButton,'BrowseAccident',,     ,loc:FormPopup,'UpdateAccident',))
          do SendPacket
        End
      End
    End
        If p_web.site.DefaultExport
          packet.append(p_web.CreateStdBrowseButton(Net:Web:ExportButton,'BrowseAccident',,,,,) & p_web.CRLF)  !b
        End
    ...
    do SendPacket
      packet.append('<div id="BrowseAccident_select_a" class="'&p_web.combine(p_web.site.style.BrowseSelectButtonSet,)&'">')
    If loc:selecting = 1 !and loc:parent = ''
      packet.append(p_web.CreateStdBrowseButton(Net:Web:BrowseCancelButton,'BrowseAccident',,,loc:popup,,))
      do SendPacket
    End
    packet.append('</div>' & p_web.CRLF)
    If p_web.site.UseSelectButtonSet
      loc:options.Free(True)
      p_web.jQuery('#' & 'BrowseAccident_select_a','controlgroup',loc:options)
...
GenerateUpdateButtonsBelow  routine
  If (loc:UpdateButtonPosition=Net:Below or loc:UpdateButtonPosition=Net:Both) and band(loc:stage,net:web:GenerateUpdates)
    ...
    End ! If p_web.site.UseUpdateButtonSet
    do SendPacket
      packet.append('<div id="BrowseAccident_select_b" class="'&p_web.combine(p_web.site.style.BrowseSelectButtonSet,)&'">')
    If loc:selecting = 1 !and loc:parent = ''
      packet.append(p_web.CreateStdBrowseButton(Net:Web:BrowseCancelButton,'BrowseAccident',,,loc:popup,,))
      do SendPacket
    End
    ...
    If p_web.site.UseSelectButtonSet
      loc:options.Free(True)
      p_web.jQuery('#' & 'BrowseAccident_select_b','controlgroup',loc:options)
    End ! If p_web.site.UseSelectButtonSet
    do SendPacket
    do SendPacket
...
GenerateNavButtonsAbove  routine
  If loc:FileLoading=Net:PageLoad and band(loc:stage,net:web:GenerateNav) and (loc:NavButtonPosition=Net:Above or loc:NavButtonPosition=Net:Both)
      ...
      packet.append(p_web.CreateStdButton('button',Net:Web:FirstButton,,,,,,loc:previousdisabled,,'BrowseAccident')) !p1
      packet.append(p_web.CreateStdButton('button',Net:Web:PreviousButton,,,,,,loc:previousdisabled,,'BrowseAccident')) !p2
      packet.append(p_web.CreateStdButton('button',Net:Web:NextButton,,,,,,loc:nextdisabled,,'BrowseAccident')) !p3
      packet.append(p_web.CreateStdButton('button',Net:Web:LastButton,,,,,,loc:nextdisabled,,'BrowseAccident')) !p4
      packet.append('</div>' & p_web.CRLF)
...
BrowseRow  routine
  ...
  If loc:eip = 0
    If(loc:InView)
      loc:field = p_web.AddBrowseValue('BrowseAccident_' & loc:RandomBrowseId,'Accident',Acc:GuidKey,ThisView)
    Else
      loc:field = p_web.AddBrowseValue('BrowseAccident_' & loc:RandomBrowseId,'Accident',Acc:GuidKey)
    End
  End
  p_web._thisrow = p_web.nocolon('Acc:Guid')
  ...
  if loc:eip = 0
    if Loc:LocatorValue <> '' and loc:ActualSelection = ''
      ...
      loc:checked = 'checked'
      do SetSelection
    elsif loc:ActualSelection = '' and Acc:Guid = p_web.GetSessionValue('Acc:Guid')
       loc:checked = 'checked'
       do SetSelection
    elsif loc:selecting = 1
      loc:checked = Choose(p_web.getsessionvalue(p_web.GetSessionValue('BrowseAccident:LookupField')) = Acc:Guid and loc:ActualSelection = '','checked','')
      if loc:checked <> '' then do SetSelection.
    else
      loc:checked = Choose((Acc:Guid = loc:selected) and loc:ActualSelection = '','checked','')
      if loc:checked <> '' then do SetSelection.
    end
...
Cells1  Routine
        ...
        If Loc:Selecting = 0
          If Loc:Eip = 0
              If p_web.RequestJson = 0
                If loc:CellStarted = false
                  packet.append(p_web.BrowseTableCellStart(clip(loc:field)&'-8',p_web.combine(' nt-flexwidth-1'),loc:ColumnNumber,1,loc:rownumber,1,'browse-cell','',loc:LayoutMethod)) !w3
                  loc:CellStarted = true
                End
              Else
                loc:CellsCounter += 1
        ...
        If Loc:Selecting = 0
          If Loc:Eip = 0
              If p_web.RequestJson = 0
                If loc:CellStarted = false
                  packet.append(p_web.BrowseTableCellStart(clip(loc:field)&'-9',p_web.combine(' nt-flexwidth-1'),loc:ColumnNumber,1,loc:rownumber,1,'browse-cell','',loc:LayoutMethod)) !w3
                  loc:CellStarted = true
                End
              Else
                loc:CellsCounter += 1
        ...
        If Loc:Selecting = 1
          If Loc:Eip = 0
              If p_web.RequestJson = 0
                If loc:CellStarted = false
                  packet.append(p_web.BrowseTableCellStart(clip(loc:field)&'-10',p_web.combine(' nt-flexwidth-1'),loc:ColumnNumber,1,loc:rownumber,1,'browse-cell','',loc:LayoutMethod)) !w3
                  loc:CellStarted = true
                End
              Else
                loc:CellsCounter += 1
...
DataDo  String(100)
  ...
  End
  If p_web.RequestJson = 0
    packet.append(p_web.BrowseTableRowStart('',' ' & clip(loc:rowstyle) & ' nt-browse-row-data browseaccident-row-data','browse-row',loc:RecordExtra.GetValue() & ' ' & dataDo,loc:LayoutMethod,))
  Else
...
StartRow  Routine
  loc:rowcount += 1
  TableQueue.Idx = loc:field !p_web.AddBrowseValue('BrowseAccident','Accident',Acc:GuidKey,ThisView)
  TableQueue.Id[1] = Acc:Guid
  Loc:cellStarted = false
...
FirstInCell                     long
  code
    do SetFormAction
    loc:options.Free(True)
    p_web.SetOption(loc:options,'procedure',lower('BrowseAccident'))
    ...
    p_web.SetOption(loc:options,'lookupField',p_web.GetSessionValue('BrowseAccident:LookupField'))
    If p_web.CanCallAddSec() = net:ok
      p_web.SetOption(loc:options,'addsec','BrowseAccident') !b
    End
...
parent_  string(252)
  code
  parent_ = p_web.SetParent(loc:parent,'BrowseAccident')
! ----------------------------------------------------------------------------------------
CallClicked  Routine
  p_web.SetSessionValue('Acc:Guid',p_web.GetValue('Acc:Guid'))
...
loc:hash  string(Net:HashSize)
  code
  do OpenFilesB
  Acc:Guid = p_web.GetSessionValue('Acc:Guid')
  loc:result = p_web.GetFile(Accident,Acc:GuidKey)
  if loc:result = 0
    loc:hash = p_web.GetBrowseHash('BrowseAccident_' & loc:RandomBrowseId,'Accident',Accident,Acc:GuidKey ,Acc:Guid)
    if loc:hash
      p_web.GetBrowseValue(loc:hash) ! primes p_web.viewpos for use in GetView
    end
  end
  loc:result = p_web.GetView(ThisView,'BrowseAccident',loc:RandomBrowseId)
  loc:InView = 1
  loc:eip = 1
  loc:viewstate = p_web.escape(p_web.Base64Encode(clip(Acc:Guid)))
  do BrowseRow
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      ...
      of net:Grid
      of net:Flex
        packet.append('<div class="' & p_web.Combine('nt-browse-flex-cell-prompt',' nt-flex nt-browse-data',,) & '">'&p_web.Translate('Date',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))&'</div>')
      End
      packet.append(p_web.DivHeader('BrowseAccident_Acc:Date_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
      packet.append( p_web.CreateHyperLink(p_web._jsok(Left(p_web.FormatValue(Acc:Date,p_web.site.datepicture)),(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,loc:javascript,,,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0),,,'BrowseAccident'))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      ...
      of net:Grid
      of net:Flex
        packet.append('<div class="' & p_web.Combine('nt-browse-flex-cell-prompt',' nt-flex nt-browse-data',,) & '">'&p_web.Translate('Time',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))&'</div>')
      End
      packet.append(p_web.DivHeader('BrowseAccident_Acc:Time_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
      packet.append( p_web.CreateHyperLink(p_web._jsok(Left(p_web.FormatValue(Acc:Time,'@t1')),(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,loc:javascript,,,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0),,,'BrowseAccident'))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      ...
      of net:Grid
      of net:Flex
        packet.append('<div class="' & p_web.Combine('nt-browse-flex-cell-prompt',' nt-flex nt-browse-data',,) & '">'&p_web.Translate('',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))&'</div>')
      End
      packet.append(p_web.DivHeader('BrowseAccident_Acc:Type_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
      packet.append( p_web.CreateHyperLink(p_web._jsok(Left(p_web.FormatValue(choose(Acc:Type,'Car','Bike','Bus','Truck','Pedestrian'),'@s20')),(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,loc:javascript,,,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0),,,'BrowseAccident'))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      ...
      End
      packet.append(p_web.DivHeader('BrowseAccident_Acc:Description_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
      packet.append( p_web.CreateHyperLink(p_web._jsok(Left(p_web.FormatValue(Acc:Description,'@s255')),(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,loc:javascript,,,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0),,,'BrowseAccident'))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      ...
      of net:Grid
      of net:Flex
        packet.append('<div class="' & p_web.Combine('nt-browse-flex-cell-prompt',' nt-flex nt-browse-data',,) & '">'&p_web.Translate('Latitude',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))&'</div>')
      End
      packet.append(p_web.DivHeader('BrowseAccident_Acc:Latitude_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
      packet.append( p_web.CreateHyperLink(p_web._jsok(Left(p_web.FormatValue(Acc:Latitude,'@n-20.12')),(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,loc:javascript,,,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0),,,'BrowseAccident'))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      ...
      of net:Grid
      of net:Flex
        packet.append('<div class="' & p_web.Combine('nt-browse-flex-cell-prompt',' nt-flex nt-browse-data',,) & '">'&p_web.Translate('Longitude',(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0))&'</div>')
      End
      packet.append(p_web.DivHeader('BrowseAccident_Acc:Longitude_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
      packet.append( p_web.CreateHyperLink(p_web._jsok(Left(p_web.FormatValue(Acc:Longitude,'@n-20.12')),(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0)),,,,loc:javascript,,,(Net:HtmlOk*0)+(Net:UnsafeHtmlOk*0),,,'BrowseAccident'))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      loc:extra = ''
      packet.append(p_web.DivHeader('BrowseAccident_Copy_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
          If p_web.CanCall('UpdateAccident',0,,) = net:ok
            If loc:viewonly = 0
               packet.append(p_web.CreateStdBrowseButton(Net:Web:SmallCopyButton,'BrowseAccident',loc:field,false,loc:FormPopup,'UpdateAccident')  & p_web.CRLF)
            End
          End
    End
    packet.append(p_web.DivFooter(Net:NoSend))
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      loc:extra = ''
      packet.append(p_web.DivHeader('BrowseAccident_Change_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
          If p_web.CanCall('UpdateAccident',0,,) = net:ok
            If loc:viewonly = 0
               packet.append(p_web.CreateStdBrowseButton(Net:Web:SmallChangeButton,'BrowseAccident',loc:field,false,loc:FormPopup,'UpdateAccident')  & p_web.CRLF)
            End
           End
    End
    packet.append(p_web.DivFooter(Net:NoSend))
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      loc:extra = ''
      packet.append(p_web.DivHeader('BrowseAccident_Delete_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
          If p_web.CanCall('UpdateAccident',0,,) = net:ok
            If loc:viewonly = 0
              packet.append(p_web.CreateStdBrowseButton(Net:Web:SmallDeleteButton,'BrowseAccident',loc:field,false,loc:FormPopup,'UpdateAccident')  & p_web.CRLF)
            End
          End
    End
    packet.append(p_web.DivFooter(Net:NoSend))
...
loc:FilterA         StringTheory
  code
    ...
    Else ! default settings for browse column
      loc:extra = ''
      packet.append(p_web.DivHeader('BrowseAccident_Select_'&Acc:Guid,' nt-flex nt-browse-data',net:crc,,loc:extra))
        packet.append(p_web.CreateStdBrowseButton(Net:Web:SmallSelectButton,'BrowseAccident',loc:field,,loc:popup))
    End
    packet.append(p_web.DivFooter(Net:NoSend))
    if loc:eip = 1
      do SendPacket
