...
$.widget( "ui.ntosk", {
	options: {
		...
		wascss:[],
		rowIndent:[],
		autoHide:1,		// 1=on, 2=off. keyboard is hidden until focus is on an entry field. Works ONLY if id is #osk.
